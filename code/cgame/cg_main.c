...
static void CG_RegisterSounds( void ) {
	...
	if ( cgs.gametype >= GT_TEAM || cg_buildScript.integer ) {
		...
		//	coltonquake3: Using flagcap_blu.wav for this sound
		cgs.media.captureAwardSound = trap_S_RegisterSound( "sound/teamplay/flagcap_blu.wav", qtrue );
		...
		if ( cgs.gametype == GT_1FCTF || cg_buildScript.integer ) {
			// FIXME: get a replacement for this sound? coltongit/coltonquake3: Edited blue flag returned to get this sound
			cgs.media.neutralFlagReturnedSound = trap_S_RegisterSound( "sound/teamplay/voc_flag_returned.wav", qtrue );
	...
	cgs.media.hitSound2 = trap_S_RegisterSound( "sound/feedback/hitihv.wav", qfalse );
