...
static void ServerOptions_InitBotNames( void ) {
	...
	if( s_serveroptions.gametype >= GT_TEAM ) {
		Q_strncpyz( s_serveroptions.botNameBuffers[1], "Sarge", 16 );
		Q_strncpyz( s_serveroptions.botNameBuffers[2], "Grunt", 16 );
		Q_strncpyz( s_serveroptions.botNameBuffers[3], "Major", 16 );
		Q_strncpyz( s_serveroptions.botNameBuffers[4], "Visor", 16 );
